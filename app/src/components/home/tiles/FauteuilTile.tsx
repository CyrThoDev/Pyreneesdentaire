      ...
      <div className="flex h-full flex-col p-6 sm:p-8">
        <div className="shrink-0">
          <div className="flex flex-col items-start gap-1">
            <h3
              className={`${titleColor} font-oswald text-4xl sm:text-5xl font-semibold uppercase leading-none tracking-tight`}
            >
              {tile.title}
            </h3>
            ...
            {tile.subtitle_1 && (
              <p
                className={`${titleColor} font-oswald text-lg sm:text-xl font-semibold uppercase leading-none tracking-tight`}
              >
                {tile.subtitle_1}
              </p>
            )}
