      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-8 md:grid-cols-[360px_1fr] md:gap-14">
          ...
          <div className="flex flex-col justify-start pt-1">
            ...
            <p className="mt-8 max-w-xl leading-5 text-neutral-700">
              {f.description}
            </p>
